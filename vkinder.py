...
class Favorites(Base):
    ...
    budding_id = db.Column(db.Integer, db.ForeignKey('budding.budding_id'), nullable=False)
...
class Budding(Base):
    ...
    favorites = relationship('Favorites', back_populates='budding')
    budding_photo = relationship('Budding_photo', back_populates='budding')
